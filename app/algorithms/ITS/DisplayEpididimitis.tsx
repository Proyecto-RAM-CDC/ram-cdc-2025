import { RequireTreatmentEpididimitis } from "~/algorithms/ITS/utilitiesForRendering";

const DisplayEpididimitis = (
    ...
    <div>
      <div className="bg-accent py-4 px-2 mb-8 border-8 border-primary rounded-md shadow-md">
        <h3 className="text-2xl pb-1 underline font-semibold leading-7 text-primary">
          ...
          <span className="italic">Epididimitis y Orquitis</span>
        </h3>
        <RequireTreatmentEpididimitis
          hasRelacionesSexualesSinProtection={
            hasRelacionesSexualesSinProtection
          }
          palpacion={palpacion}
          medicamentos={medicamentos}
          aumento={aumento}
          instrumentation_tract={instrumentation_tract}
          hasSexoAnal={hasSexoAnal}
...
export default DisplayEpididimitis;
