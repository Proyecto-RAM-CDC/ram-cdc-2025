import { RequireTreatementProctitis } from "~/algorithms/ITS/utilitiesForRendering";

const DisplayProctitis = (
  hasDiarrea: boolean,
    ...
    <div>
      <div className="bg-accent py-4 px-2 mb-8 border-8 border-primary rounded-md shadow-md">
        <h3 className="text-2xl pb-1 underline font-semibold leading-7 text-primary">
          ...
          <span className="italic">Proctitis</span>
        </h3>

        <RequireTreatementProctitis
          hasDiarrea={hasDiarrea}
          hasDolorRectal={hasDolorRectal}
          hasFiebre={hasFiebre}
          hasFisuras={hasFisuras}
          hasHipotension={hasHipotension}
          hasLinfadenopatias={hasLinfadenopatias}
          hasRectorregia={hasRectorregia}
        />
      </div>
...
export default DisplayProctitis;
